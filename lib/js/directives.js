	...
	return {
	  ...
	  link: function (scope, element, attrs) {
		...
		var LiteMolComponent = (function () {
			...
			LiteMolComponent.prototype.loadFromSdf = function(url, format) {
				var id = this.moleculeId.toLowerCase();
			...
			LiteMolComponent.prototype.loadFromNonSdf = function(url, format) {
				var id = this.moleculeId.toLowerCase();
			...
			LiteMolComponent.prototype.loadMolecule = function() {
				...
				if(typeof scope.sourceFormat !== 'undefined' && scope.sourceFormat.toLowerCase() == 'sdf'){
					var action = this.loadFromSdf(url, format);
				}else{
					var action = this.loadFromNonSdf(url, format);
				}
